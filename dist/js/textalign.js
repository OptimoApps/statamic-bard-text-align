...
function markInputRule (regexp, markType, getAttrs) {
  return new prosemirror_inputrules__WEBPACK_IMPORTED_MODULE_2__["InputRule"](regexp, (state, match, start, end) => {
...
function pasteRule (regexp, type, getAttrs) {
  ...
  return new prosemirror_state__WEBPACK_IMPORTED_MODULE_3__["Plugin"]({
    props: {
      transformPasted: slice => new prosemirror_model__WEBPACK_IMPORTED_MODULE_4__["Slice"](handler(slice.content), slice.openStart, slice.openEnd)
    }
  });
}
...
function removeMark (type) {
  return (state, dispatch) => {
    ...
    if (empty) {
      const range = Object(tiptap_utils__WEBPACK_IMPORTED_MODULE_5__["getMarkRange"])($from, type);
      from = range.from;
      to = range.to;
    }
...
function splitToDefaultListItem(itemType) {
  return function (state, dispatch) {
    ...
    if ($from.parent.content.size == 0) {
      ...
      if (dispatch) {
        let wrap = prosemirror_model__WEBPACK_IMPORTED_MODULE_4__["Fragment"].empty;
        const keepItem = $from.index(-1) > 0; // Build a fragment containing empty versions of the structure
        // from the outer list item to the parent node of the cursor

        for (let d = $from.depth - (keepItem ? 1 : 2); d >= $from.depth - 3; d--) wrap = prosemirror_model__WEBPACK_IMPORTED_MODULE_4__["Fragment"].from($from.node(d).copy(wrap)); // Add a second list item with an empty default start node


        wrap = wrap.append(prosemirror_model__WEBPACK_IMPORTED_MODULE_4__["Fragment"].from(itemType.createAndFill()));
        const tr = state.tr.replace($from.before(keepItem ? null : -1), $from.after(-3), new prosemirror_model__WEBPACK_IMPORTED_MODULE_4__["Slice"](wrap, keepItem ? 3 : 2, 2));
...
function toggleBlockType (type, toggletype, attrs = {}) {
  return (state, dispatch, view) => {
    const isActive = Object(tiptap_utils__WEBPACK_IMPORTED_MODULE_5__["nodeIsActive"])(state, type, attrs);
...
function toggleList(listType, itemType) {
  return (state, dispatch, view) => {
    ...
    const parentList = Object(prosemirror_utils__WEBPACK_IMPORTED_MODULE_6__["findParentNode"])(node => isList(node, schema))(selection);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _textAlign__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./textAlign */ "./resources/js/textAlign.js");
/*
 * *
...
Statamic.$bard.extend(function (_ref) {
  var mark = _ref.mark;
  return mark(new _textAlign__WEBPACK_IMPORTED_MODULE_0__["default"]());
});
...
/* harmony import */ var tiptap_commands__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tiptap-commands */ "./node_modules/tiptap-commands/dist/commands.esm.js");
  ...
  _createClass(TextAlign, [{
    ...
    value: function schema() {
      return {
        ...
        toDOM: function toDOM(mark) {
          return ['span', {
            style: "text-align: ".concat(mark.attrs.align, "; display: block")
          }, 0];
        }
      };
    }
    ...
    value: function commands(_ref) {
      ...
      return function (attrs) {
        return Object(tiptap_commands__WEBPACK_IMPORTED_MODULE_0__["updateMark"])(type, attrs);
      };
    }
  }, {
    key: "inputRules",
    value: function inputRules(_ref2) {
      var type = _ref2.type;
      return [Object(tiptap_commands__WEBPACK_IMPORTED_MODULE_0__["markInputRule"])(/(?:\*\*|__)([^*_]+)(?:\*\*|__)$/, type)];
    }
  }, {
    key: "plugins",
...
module.exports = __webpack_require__(/*! /Users/satz/starter-kit-cool-writings/addons/statamic-bard-text-align/resources/js/bard.js */"./resources/js/bard.js");
